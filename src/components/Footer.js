    ...
    return (
        <>
            <footer id="footer">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6">
                                <div className="footer-info">
                                    <h3>Yash<span>.</span></h3>
                                    <p>
                                        Pune <br />
                                        Maharastra, Bharat<br /><br />
                            ...
                            <div className="col-lg-4 col-md-6 footer-newsletter">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin auctor suscipit tincidunt.</p>
                                <form>
                ...
                <div className="container">
                    <div className="copyright">&copy; Copyright <strong><span>Yash</span></strong>. All Rights Reserved</div>
